...
/**
 * Notification to admin when a new user registers
 */
export function getAdminNewUserEmailTemplate(userName: string, userEmail: string, registeredAt: string): { subject: string; html: string; text: string } {
  return {

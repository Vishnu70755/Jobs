...
export default function Analytics() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    // Refetch every 5 minutes instead of every second to reduce load
            ...
            <ResponsiveContainer width="100%" height="100%">
              {timelineChart === "pie" ? (
                ...
                <BarChart data={statusData} layout="vertical" margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
                  ...
                  <YAxis dataKey="status" type="category" stroke="hsl(var(--mixed-foreground))" fontSize={10} tickLine={false} axisLine={false} width={105} />

...
export const UnsaveJobResponse = zod.unknown()
 ...
 */
export const createAdminJobBodyIsNewDefault = true;
export const createAdminJobBodyIsHotDefault = false;
...
export const CreateAdminJobBody = zod.object({
  ...
  "source": zod.string(),
  "applyUrl": zod.string().nullish(),
  "isNew": zod.boolean().default(createAdminJobBodyIsNewDefault),
  "isHot": zod.boolean().default(createAdminJobBodyIsHotDefault)
})
